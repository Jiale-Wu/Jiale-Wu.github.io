document.addEventListener('DOMContentLoaded', function() {
    ...
    function prefillForm() {
        document.getElementById('name').value = 'Jay Wu';
        document.getElementById('mascot').value = 'Jubilant Womabt';
        document.getElementById('imageCaption').value = 'silly .5 of me';
        document.getElementById('personalBackground').value = 'I was born in China and moved to North Carolina in 2011. Some of my hobbies include volleyball, video games, and working out.';
        document.getElementById('professionalBackground').value = 'CCP student in high school and currently an undergraduate stuend majoring in Computer Science';
        document.getElementById('academicBackground').value = 'This is my first time taking web development but I am looking forward to learning about all the things that I can implement into my future/current projects.';
        document.getElementById('platform').value = 'Currently using my macbook but I have a Windows computer at home.';
        document.getElementById('funnyThing').value = 'My elbow is double-jointed so when I fully stretch out my arm, it is going in the opposite direction in an obtuse angle.';
    }
